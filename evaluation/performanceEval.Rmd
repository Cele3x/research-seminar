...
cat("\n\nVLO1 ANOVA: ===========================================================================================\n")  
round_df(anova(art(el1 ~ Model + (1|probandId), data=questionnaireDataReshape)),3)
cat("\n\nVLO2 ANOVA: ===========================================================================================\n")  
round_df(anova(art(el2 ~ Model + (1|probandId), data=questionnaireDataReshape)),3)
cat("\n\nVLO3 ANOVA: ===========================================================================================\n")  
round_df(anova(art(el3 ~ Model + (1|probandId), data=questionnaireDataReshape)),3)
cat("\n\nVLO4 ANOVA: ===========================================================================================\n")  
round_df(anova(art(el4 ~ Model + (1|probandId), data=questionnaireDataReshape)),3)

res <- round_df(testInteractions(artlm(art(el4 ~ Model + (1|probandId), data=questionnaireDataReshape), "Model"), pairwise=c("Model"), adjustment="bonf") ,3)  
res[res$'Pr(>Chisq)'<=0.05,]
cat("\n\nVLO5 ANOVA: ===========================================================================================\n")  
round_df(anova(art(el5 ~ Model + (1|probandId), data=questionnaireDataReshape)),3)
cat("\n\nVLO6 ANOVA: ===========================================================================================\n")  
round_df(anova(art(el6 ~ Model + (1|probandId), data=questionnaireDataReshape)),3)
cat("\n\nVLO7 ANOVA: ===========================================================================================\n")  
round_df(anova(art(el7 ~ Model + (1|probandId), data=questionnaireDataReshape)),3)
cat("\n\nVLO8 ANOVA: ===========================================================================================\n")  
round_df(anova(art(el8 ~ Model + (1|probandId), data=questionnaireDataReshape)),3)
cat("\n\nVLO9 ANOVA: ===========================================================================================\n")  
round_df(anova(art(el9 ~ Model + (1|probandId), data=questionnaireDataReshape)),3)
cat("\n\nVLO10 ANOVA: ===========================================================================================\n")  
round_df(anova(art(el10 ~ Model + (1|probandId), data=questionnaireDataReshape)),3)
...
dfLogsResultSet$condition <- factor(dfLogsResultSet$condition)
...
```{r}
round_df(anova(art(freq ~ condition + (1|probandId), data=dfLogsResultSet)))

means <- aggregate(freq ~ condition, dfLogsResultSet, function (x) c(mean = mean(x), ci = qt(0.95,df=length(x)-1)*sd(x)/sqrt(length(x))))
means <- do.call(data.frame, means)
means$freq.mean <- round(means$freq.mean, 3)
means$condition <- c("0F","12F","24F","36F","48F","-12F")

ggplot(means, aes(x=condition,y=freq.mean,fill=condition, label = freq.mean)) +
...
```
```{r}
round_df(anova(art(freq ~ condition * as.factor(condition) + (1|probandId), data=dfLogsResultSet)))
round_df(anova(art(freq ~ condition + (1|probandId), data=dfLogsResultSet)))

summary(lm(freq ~ condition +  (1|probandId), dfLogsResultSet))
```
